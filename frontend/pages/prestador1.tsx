      ...
      <Layout>
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="text-center text-orange-500 text-lg animate-pulse">
            <svg className="animate-spin h-8 w-8 text-orange-400 mx-auto mb-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
      ...
      <div className="min-h-screen bg-orange-50 pt-24 pb-12 px-4">
        <div className="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-md space-y-4">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <input name="enderecoResidencial" value={formData.enderecoResidencial} onChange={handleChange} className="input-field" placeholder="Endereço residencial" />
